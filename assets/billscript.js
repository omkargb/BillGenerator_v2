...
function insertNewRecord(data) {
    ...
    cell3 = newRow.insertCell(2);   cell3.innerHTML = data.pprice;	cell3.className='text-right';
...
function resetEditForm() {
	...
	document.getElementById("editform").style.backgroundColor = "#ffffff";
...
function onEdit(td) {
	...
	var my_element = document.getElementById("editform");
	...
	document.getElementById("editform").style.backgroundColor = "#F0fff0";
